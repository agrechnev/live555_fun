...
public: //================ Methods
    ...
    void parse(void *inData, size_t inSize, std::function<void(int, int, int, void*, void*, void*)> callBack);
...
private: //================ Methods
    ...
    void decode(std::function<void(int, int, int, void*, void*, void*)> callBack);
private: //============= Data
    /// Image width
    int width;
    /// Image height
